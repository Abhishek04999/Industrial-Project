...
<div class="home-content">
    ...
    <form method="POST"  action="{{route('createques.ques')}}">
        ...
        <div class="row mb-4" style="margin-left: 2vw;">
          ...
          <div class="col-sm-5">
            <input type="text" style="width: 20vw" name="qtitle" class="form-control" id="inputEmail3">
          </div>
        </div>
        <div class="row mb-4" style="margin-left: 2vw;">
          <label for="inputPassword3" class="col-sm-6 col-form-label">Enter Total Number of Question</label>
          <div class="col-sm-5">
            <input type="number" style="width: 20vw" name="questotlnumber" class="form-control" id="inputPassword3">
          </div>
        </div>
        <div class="row mb-4" style="margin-left: 2vw;">
          <label for="inputPassword3" class="col-sm-6 col-form-label">Enter Marks on Right Answer</label>
          <div class="col-sm-5">
            <input type="number" style="width: 20vw" name="rightmarksans" class="form-control" id="inputPassword3">
          </div>
        </div>
        <div class="row mb-4" style="margin-left: 2vw;">
          <label for="inputPassword3" class="col-sm-6 col-form-label">Enter Marks on Wrong Answer Without Sign</label>
          <div class="col-sm-5">
            <input type="number" style="width: 20vw" name="wrongmarkans" class="form-control" id="inputPassword3">
          </div>
        </div>
        <div class="row mb-4" style="margin-left: 2vw;">
          <label for="inputPassword3" class="col-sm-6 col-form-label">Enter Time Limit for Test </label>
          <div class="col-sm-5">
            <input type="number" style="width: 20vw" name="timelimit" class="form-control" id="inputPassword3">
          </div>
        </div>
